...
**🚨 CRITICAL NO TIMEFRAMES RULE**: When generating PRP documents, NEVER include development timeframes, deadlines, or time estimates. These documents are for AI coding assistants where features can be built rapidly, making timeframes irrelevant.

❌ **AVOID THESE PATTERNS**:
- "Phase 1: Core Infrastructure (Week 1-2)"
- "Implementation Timeline: 2-4 weeks"
- "Sprint 1 (Week 1): Setup and configuration"
- "Short-term (1-2 months)"
- Any time-based implementation plans
